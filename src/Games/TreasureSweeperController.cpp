...
namespace
{
	...
	const float DIG_DROP_THRESHOLD = 0.55f;
	...
	const float FALLBACK_THRESHOLD_SCALE = 0.05f;
	...
	const int WIN_CONFETTI_COUNT = 220;
...
void CTreasureSweeperController::setup(std::shared_ptr<KinectProjector> const& k)
{
	...
	fontsLoaded = largeFont.load("verdana.ttf", 96, true, true, true);
	fontsLoaded = mediumFont.load("verdana.ttf", 64, true, true, true) && fontsLoaded;
	fontsLoaded = smallFont.load("verdana.ttf", 42, true, true, true) && fontsLoaded;
	startRound();
}
...
void CTreasureSweeperController::drawProjectorWindow()
{
	...
	if (roundState == ROUND_INTRO)
	{
		...
		if (fontsLoaded)
		{
			drawTextAllSides("TREASURE SWEEPER", mediumFont, 1.2f, ofColor(255,255,255,245), -0.07f);
			drawTextAllSides("GET READY: " + ofToString(introCountdown), smallFont, 1.05f, ofColor(255,255,255,245), 0.10f);
		}
		else
		{
	...
	if (roundState == ROUND_WIN)
	{
		...
		if (fontsLoaded)
		{
			drawTextAllSides("YOU WIN!", largeFont, 1.0f, ofColor(255, 250, 180, 245), -0.10f);
			drawTextAllSides("Next round: " + ofToString(nextRoundCountdown), mediumFont, 0.95f, ofColor(255, 240, 170, 245), 0.16f);
		}
		else
		{
			drawTextAllSidesBitmap("YOU WIN!", 9.0f, ofColor(255, 250, 180, 245), -0.10f);
			drawTextAllSidesBitmap("Next round: " + ofToString(nextRoundCountdown), 4.0f, ofColor(255, 240, 170, 245), 0.16f);
		}
	}
	else if (roundState == ROUND_LOSE)
	{
		...
		if (fontsLoaded)
		{
			drawTextAllSides("YOU LOSE", largeFont, 0.95f, ofColor(255, 120, 120, 245), -0.10f);
			drawTextAllSides(loseHeadline, mediumFont, 0.9f, ofColor(255, 170, 170, 245), 0.10f);
			drawTextAllSides("Next round: " + ofToString(nextRoundCountdown), smallFont, 0.95f, ofColor(255, 200, 200, 245), 0.24f);
		}
		else
		{
			drawTextAllSidesBitmap("YOU LOSE", 8.5f, ofColor(255, 120, 120, 245), -0.10f);
			drawTextAllSidesBitmap(loseHeadline, 4.5f, ofColor(255, 170, 170, 245), 0.10f);
			drawTextAllSidesBitmap("Next round: " + ofToString(nextRoundCountdown), 3.7f, ofColor(255, 200, 200, 245), 0.24f);
		}
	}
	else
	{
