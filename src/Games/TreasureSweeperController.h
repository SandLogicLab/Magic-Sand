...
private:
	...
	void drawGrid() const;
	void drawHud() const;
	void drawTextAllSides(const std::string& msg, const ofTrueTypeFont& font, float scale, const ofColor& color, float yOffsetNorm) const;
	...
	std::vector<float> riseMemory;
	std::vector<double> suppressDropUntil;
